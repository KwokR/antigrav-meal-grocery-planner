            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-7 gap-3">
                {DAYS.map((day, dayIndex) => {
                    ...
                    return (
                        <div
                            key={day}
                            className={`bg-white rounded-2xl border-2 overflow-hidden transition-all duration-200 hover:shadow-lg ${highIronFocus && hasHighIron
                        ...
                        >
                            ...
                            <div className={`px-4 py-3 border-b-2 ${highIronFocus && hasHighIron
                                ...
                                <div className="flex justify-between items-center">
                                    <div>
                                        ...
                                        <div className="text-xs text-warm-600 lg:hidden">{day}</div>
                                    </div>
                                            ...
                                            >
                                                <div className="flex justify-between items-start gap-2">
                                                    ...
                                                    <button
                                                        ...
                                                        className="text-warm-300 hover:text-coral-500 opacity-0 group-hover:opacity-100 transition-all duration-200 hover:scale-110"
                            ...
                            <div className="px-3 pb-3">
                                <select
                                    className="w-full text-xs border-2 border-dashed border-warm-300 rounded-lg px-3 py-2 bg-white text-warm-600 outline-none focus:border-jade-500 hover:border-jade-400 transition-colors cursor-pointer font-medium"
                                    onChange={(e) => {
                                        if (e.target.value) {
